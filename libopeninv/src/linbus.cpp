...
/** \brief Initialise the hardware associated with a previously created LIN bus object */
...
#else // !STM32F1 — no-op base; subclass provides hardware implementation

LinBus::LinBus() {}
LinBus::LinBus(uint32_t /*usart*/, int /*baudrate*/) {}
void LinBus::Init(uint32_t /*usart*/, int /*baudrate*/) {}
void LinBus::Request(uint8_t /*id*/, uint8_t* /*data*/, uint8_t /*len*/) {}
bool LinBus::HasReceived(uint8_t /*id*/, uint8_t /*requiredLen*/) { return false; }

#endif // STM32F1

/** \brief Calculate LIN enhanced checksum (includes PID in sum) */
