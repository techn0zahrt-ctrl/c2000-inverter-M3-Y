...
class CanMap: CanCallback
{
   ...
   private:
      ...
      /* Legacy flash format structures (used only by LegacyLoadFromFlash) */
      ...
      {
         uint16_t    canId;
         LEGACY_CANPOS items[8]; /* 8 items per legacy message */
      };
      ...
      static void ConvertLegacyMap(CanMap* self, LEGACY_CANIDMAP* m, CANIDMAP* newIdMap, bool gainToFloat, int legacyMaxMessages, int maxItemsPerMessage, int canidUnset);
